      ...
      {selectedPlayer ? (
          ...
          <div className="flex-1">
            ...
            <div className="text-sm text-gray-700">
              ...
              {selectedPlayer.currentTeam && (
                <span> • {selectedPlayer.currentTeam.name}</span>
              )}
            </div>
          </div>
          <button
        ...
        <div className="relative">
          <input
            ...
            className="w-full p-4 border-2 border-gray-200 rounded-lg focus:border-green-500 
          ...
          {isOpen && results.length > 0 && (
            <div className="absolute top-full left-0 right-0 bg-white border border-gray-200 
                          rounded-lg mt-1 shadow-lg z-10 max-h-64 overflow-y-auto">
              {results.map((player) => (
                <div
                  key={player.id}
          ...
          {isOpen && results.length === 0 && query.length >= 2 && !isLoading && (
            <div className="absolute top-full left-0 right-0 bg-white border border-gray-200 
                          rounded-lg mt-1 shadow-lg z-10 p-4 text-center text-gray-800">
